export default function About(){
    return(
        <section id="about" className=" flex flex-col items-center justify-center h-screen text-center w-1/2 text-[25px] ">
            <span className="font-bold p-5 text-[40px]">ABOUT ME</span>
            <span className="p-1">I am currently a Brooklyn College student majoring in Computer Science.</span>
